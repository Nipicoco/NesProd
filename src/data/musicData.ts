...
export const albums: Album[] = [
    ...
    },
    {
        ...
        spotifyUrl: 'https://open.spotify.com/album/2f9UrdMcXrlf6Sw9UOe2bx?si=vamKHSyeSX6oDYcc6K_Z-Q',
        songs: [
            {
                id: '5',
                title: 'QUE LE DE',
                ...
                album: 'NES WORLD',
                cover: getImageUrl('quelede.jpg'),
                audioSrc: getAudioUrl('quelede.mp3'),
                duration: 165,
                releaseDate: 'Abril 2024',
                genre: 'Hip-Hop',
                totalplays: 1000000,
                description: 'Tema introductorio del álbum NES WORLD que establece el tono del proyecto.'
            },
            {
                id: '6',
                title: 'Mi Nena',
                artist: 'NES, Lucky Brown',
                album: 'NES WORLD',
                cover: getImageUrl('quelede.jpg'),
                audioSrc: getAudioUrl('minena.mp3'),
                duration: 195,
                releaseDate: 'Abril 2024',
                genre: 'Hip-Hop',
                totalplays: 1500000,
                description: 'Una exploración nocturna de sonidos urbanos y melodías envolventes.'
            }
        ]
    }
